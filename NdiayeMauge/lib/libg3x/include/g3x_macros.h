/* ===============================================================
  ...
  /* couleur : mapping scalaire  : cr�e le vecteur a*V (produit simple) */
  ...
  /* couleur : mapping vectoriel : cr�e le vecteur V*W (produit direct) */
